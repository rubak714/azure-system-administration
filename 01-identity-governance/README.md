...
graph TB
    ...
    style People fill:#2a2a2a,stroke:#e0e0e0,stroke-width:2px,color:#e0e0e0
    style Roles fill:#2a2a2a,stroke:#e0e0e0,stroke-width:2px,color:#e0e0e0
    style Target fill:#2a2a2a,stroke:#e0e0e0,stroke-width:2px,color:#e0e0e0
    style Guards fill:#2a2a2a,stroke:#e0e0e0,stroke-width:2px,color:#e0e0e0
    style U1 fill:#404040,stroke:#e0e0e0,stroke-width:1px,color:#e0e0e0
    style U2 fill:#404040,stroke:#e0e0e0,stroke-width:1px,color:#e0e0e0
    style GRP fill:#404040,stroke:#e0e0e0,stroke-width:1px,color:#e0e0e0
    style R1 fill:#404040,stroke:#e0e0e0,stroke-width:1px,color:#e0e0e0
    style R2 fill:#404040,stroke:#e0e0e0,stroke-width:1px,color:#e0e0e0
    style RG fill:#404040,stroke:#e0e0e0,stroke-width:1px,color:#e0e0e0
    style LOCK fill:#404040,stroke:#e0e0e0,stroke-width:1px,color:#e0e0e0
    style POL fill:#404040,stroke:#e0e0e0,stroke-width:1px,color:#e0e0e0
```
...
```mermaid
graph TB
    ENTRA["🪪 ENTRA ID<br/>Users and Groups"]
    
    RBAC["🎯 RBAC ROLES<br/>Reader | Contributor | Owner"]
    
    SCOPE["📍 SCOPE<br/>Subscription - RG - Resource"]
    
    IAM["🎮 IAM PORTAL<br/>Role Assignment"]
    
    GUARD["🛡️ GUARDRAILS<br/>Policy and Locks"]
    ...
    style ENTRA fill:#2a2a2a,stroke:#e0e0e0,stroke-width:2px,color:#e0e0e0
    style RBAC fill:#404040,stroke:#e0e0e0,stroke-width:2px,color:#e0e0e0
    style SCOPE fill:#2a2a2a,stroke:#e0e0e0,stroke-width:2px,color:#e0e0e0
    style IAM fill:#404040,stroke:#e0e0e0,stroke-width:2px,color:#e0e0e0
    style GUARD fill:#2a2a2a,stroke:#e0e0e0,stroke-width:2px,color:#e0e0e0
```
